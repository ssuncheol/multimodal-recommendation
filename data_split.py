...
parser.add_argument('--save_path', default='./movielens_dataset', type=str,
                    help='savepath')
parser.add_argument('--split_type', default='leave', type=str,
                    help='leave/ratio')
...
# save
train_positive[['userid','train_pos']].to_csv(os.path.join(args.save_path, 'train_positive.csv'),index=False)
